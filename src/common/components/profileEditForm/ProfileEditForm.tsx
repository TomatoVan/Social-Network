  ...
  return (
    <>
      <form className={s.profileEditBox} onSubmit={handleSubmit(onSubmit)}>
        <div className={s.main}>
          <div className={s.containerLeft}>
            ...
            <div className={s.element}>
              <b>Full name: </b>
              <input id={'fullName'} {...register('fullName')} className={s.inputElement} />
            </div>
            ...
            <div className={s.element}>
              <b>About me: </b>
              <input id={'aboutMe'} {...register('aboutMe')} className={s.inputElement} />
            </div>
          </div>
          ...
          <div className={s.containerRight}>
            ...
            <div className={s.element}>
              <b>VK: </b>
              <input id={'contacts.vk'} {...register('contacts.vk')} className={s.inputElement} />
            </div>
        ...
        <button type={'submit'} className={s.buttonSaveProfile}>
          save
        </button>
      </form>
    </>
